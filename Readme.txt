...
This plugin contain a single PartModule to prevent control surfaces from working based on an animation state or any other module implementing IScalarModule.
